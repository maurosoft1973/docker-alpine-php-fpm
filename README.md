...
* ```:3.14.1``` 3.14.1 branch based (Automatic Architecture Selection)
* ```:3.14.1-aarch64```   3.14.1 64 bit ARM
* ```:3.14.1-armhf```     3.14.1 32 bit ARM v6
* ```:3.14.1-armv7```     3.14.1 32 bit ARM v7
* ```:3.14.1-ppc64le```   3.14.1 64 bit PowerPC
* ```:3.14.1-x86```       3.14.1 32 bit Intel/AMD
* ```:3.14.1-x86_64```    3.14.1 64 bit Intel/AMD
* ```:3.14.1-7.4.26-r0``` 3.14.1-7.4.26-r0 branch based (Automatic Architecture Selection)
* ```:3.14.1-7.4.26-r0-aarch64```   3.14.1 64 bit ARM
* ```:3.14.1-7.4.26-r0-armhf```     3.14.1 32 bit ARM v6
* ```:3.14.1-7.4.26-r0-armv7```     3.14.1 32 bit ARM v7
* ```:3.14.1-7.4.26-r0-ppc64le```   3.14.1 64 bit PowerPC
* ```:3.14.1-7.4.26-r0-x86```       3.14.1 32 bit Intel/AMD
* ```:3.14.1-7.4.26-r0-x86_64```    3.14.1 64 bit Intel/AMD
...
***
###### Last Update 16.04.2022 13:58:30
