...
if [ "$TOKEN" != "null" ]; then
    ...
    if [ "$RELEASE" == "TEST" ]; then
        ...
        echo "Push Image -> ${DOCKER_IMAGE}:${ALPINE_VERSION}-${PHP_VERSION}-${ALPINE_ARCHITECTURE}"
        docker push ${DOCKER_IMAGE}:${ALPINE_VERSION}-${PHP_VERSION}-${ALPINE_ARCHITECTURE}
        ...
        echo "Push Image -> ${DOCKER_IMAGE}:${PHP_VERSION}-${ALPINE_ARCHITECTURE}"
        docker push ${DOCKER_IMAGE}:${PHP_VERSION}-${ALPINE_ARCHITECTURE}
